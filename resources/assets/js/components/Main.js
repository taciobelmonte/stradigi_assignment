...
class Main extends Component {
    ...
    getImages = () =>{
        ...
        Api.getInfo('https://stadigi.herokuapp.com/api/getgallery/?offset='+this.state.offset).then(items => {
            const images = [];
    ...
    search = (query) => {
        ...
        Api.getInfo('https://stadigi.herokuapp.com/api/getsearch/?query='+ query).then((response) => {
            const images = [];
